...
public class MyPagerHandler_GoodsInfo extends Handler {
    ...
    private WeakReference<GoodsInfoActivity> weakReference;
    private int currentItem = 0;

    public MyPagerHandler_GoodsInfo(WeakReference<GoodsInfoActivity> weakReference) {
    ...
    public void handleMessage(Message msg) {
        ...
        GoodsInfoActivity activity = weakReference.get();
        if (activity == null)
            return;
