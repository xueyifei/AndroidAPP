...
import com.example.xue2015.myandroidapp.WelcomeActivity;
 ...
 */
public class MyPagerHandler_Welcome extends Handler {
    /**
     * 请求更新显示的View
     */
    ...
    public MyPagerHandler_Welcome(WeakReference<WelcomeActivity> weakReference) {
