...
import com.example.xue2015.myandroidapp.MainActivity;

import android.os.Handler;
import android.os.Message;

public class MyMainPagerHandler extends Handler {
	...
	public MyMainPagerHandler(WeakReference<MainActivity> weakReference) {
